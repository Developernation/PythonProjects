...
def build_frame(label_text_info,box_width):
    frame1 = tk.Frame(master=window,relief=border_effects['flat'],width=100, height=10)
...
frame3 = tk.Frame(master=window,relief=border_effects['flat'],width=50, height=10)
...
frame5 = tk.Frame(master=window,relief=border_effects['flat'],width=100, height=10)
...
frame4 = tk.Frame(master=window,relief=border_effects['flat'],width=100, height=10)
